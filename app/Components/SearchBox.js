...
export const SearchBox = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex border border-gray--200 rounded-full shadow-lg px-6
    py-3 ml-10 mr-5 flex-grow max-w-3xl items-center">
      ...
      <BsFillMicFill className="hidden sm:inline-flex text-4xl text-blue-500 border-1-2 border-gray-300 mr-3 pl-4"/>
